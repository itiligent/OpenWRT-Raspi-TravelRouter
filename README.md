...
**1.** Research and obtain a Linux compatible USB Wifi adapter with a chipset that supports **AP mode**. _(1 radio for Wifi piggyback, 1 radio for all your Wifi clients)._
